...
public class Sc7SteamingManagementController {
   ...
   public boolean createOwnStreamEndpoint(StreamingRequestErrorListener errorListener) {
      GeoLocation lastLocation = _sc7locationManager.getLastLocation();
      _ownStreamEndpoint = _streamingManagementController
            .requestStreamCreation(lastLocation, errorListener);
   ...
   public boolean requestNextStreamEndpoint(StreamingRequestErrorListener errorListener) {
      ...
      _currentNextStreamEndpoint = _streamingManagementController
            .requestNextStreamEndpoint(_ownStreamEndpoint.getStreamInfo(), errorListener);
   ...
   public StreamReport requestUpdateOwnStreamInfo(StreamingRequestErrorListener errorListener) {
      return _streamingManagementController
            .requestUpdateOwnStreamInfo(_ownStreamEndpoint.getStreamInfo(), errorListener);
   }
}
